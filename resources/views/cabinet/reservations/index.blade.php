...
<div class="container py-6">
    ...
    {{ $reservation->tour->title ?? $reservation->service->title ?? 'Без названия' }}
</h2>
                    ...
                    <p class="text-sm text-gray-700 mb-2">
                        ...
                        Текущий этап: Текущий этап: <strong>{{ $reservation->currentStep()?->title ?? '—' }}</strong>
                    </p>
                    ...
                    <div class="text-right">
                        <a href="{{ route('reservations.show', $reservation) }}" class="text-sm text-blue-600 hover:underline">Подробнее</a>
                    </div>
                </div>
            @endforeach
        </div>
